...
void riemann_solver(const ublas::vector<double> &u_boundary_internal,
                    ...
                    const double normal_1d, ublas::vector<double> &numerical_flux) {
    /*
     ...
     *  Actions
     *  ----------
     *  Given two state vectors from each side of boundary interfaces, calculate numerical
     *  flux for 1D scalar wave equation
     *
     */
